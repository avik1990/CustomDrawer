...
public class MainActivityWOM extends AppCompatActivity implements MenuAdapterWOM.GetIdFromMenuAdapter, View.OnClickListener {

    List<MenuItems> listMenuItem = new ArrayList<>();
    MenuAdapterWOM menuAdapter;
    Context context;
    ...
    private void inflateAdapter() {
        menuAdapter = new MenuAdapterWOM(context, listMenuItem, this);
    ...
    private void inflateMenuItems() {
        ...
        listMenuItem.add(new MenuItems("7", "Logout", "https://cdn0.iconfinder.com/data/icons/kameleon-free-pack-rounded/110/Settings-5-512.png","I"));
    }
